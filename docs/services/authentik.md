...
| `gaming`  | `policy-group-gaming`  | People invited to play in the TTRPG campaign(s) via Grimoire/FoundryVTT (and any hand-picked family members) — see [grimoire.md](grimoire.md#access--the-gaming-group) and [foundryvtt.md](foundryvtt.md#access--authentik-forwardauth-no-native-sso) |
