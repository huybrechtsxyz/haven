...
| A    | `grimoire.{base-domain}`       |          | `<forge-ip>` | 3600 | Grimoire (TTRPG library manager)                                                                                                                                                                                                                                                                                                                                                      |
| A    | `foundry.{base-domain}`        |          | `<forge-ip>` | 3600 | Foundry Virtual Tabletop (VTT server)                                                                                                                                                                                                                                                                                                                                                 |
| A    | `rpgkeeper.{base-domain}`      |          | `<forge-ip>` | 3600 | RPGKeeper (character sheet manager)                                                                                                                                                                                                                                                                                                                                                   |
